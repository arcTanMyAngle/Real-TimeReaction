...
from src.python.data_handler import DataHandler
from src.python.data_analyzer import DataAnalyzer
...
def main():
   ...
   print("6. Press 'a' to show analysis\n")
           ...
           if stimuli.is_stimulus_active:
               if stimuli.get_current_stimulus_duration() > 2000:
                   ...
                   if reaction_time is not None:
                       ...
                       data_handler.save_reaction(
                           datetime.now(),
                           reaction_time,
                           stimuli.current_stimulus['type'],
                           stimuli.current_stimulus['color']
                       )
